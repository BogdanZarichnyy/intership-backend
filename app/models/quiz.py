...
class Quiz(Base):
  ...
  participation_count: Mapped[int] = mapped_column(default=0, nullable=False)
  ...
  questions = relationship(
    ...
    lazy="selectin"  # завантажує всі питання одним запитом
  )
...
class QuizQuestion(Base):
  ...
  options = relationship(
    ...
    cascade="all, delete-orphan",
    lazy="selectin"  # завантажує всі опції одного питання одним запитом
  )
